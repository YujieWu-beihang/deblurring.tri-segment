function S = ThreeDeblur_long(Im, kernel, c1, c2, opts, kappa)
...
while beta_pixel<beta_pixel_max
    ...
    while beta_i < beta_i_max
        ...
        while beta_g<beta_g_max
            Denormin = Den_KER + beta_g*Denormin2 + beta_pixel*(with_DCP+with_BCP) + beta_i*with_TCL;
            ...
            Normin = Normin1 + beta_g*Normin2fft + beta_pixel*(u_DCPfft+u_BCPfft) + beta_i*ufft;
