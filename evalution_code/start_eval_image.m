...
MYPATH = ['/media/wyj/HDD/Dataset/Deblur/Lai_CVPR2016_Benchmark/all_deblurred_results/synthetic_uniform/manmade_01_kernel_01'];
...
for iM = 1 : length(metric)
  for iImg = imgNo
    for iKern = kernNo
      if ~isempty(intersect([iImg iKern],exclude))
        continue
      end
